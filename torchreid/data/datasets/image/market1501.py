...
class Market1501(ImageDataset):
    ...
    def __init__(self, root='', market1501_500k=False, **kwargs):
        ...
        query,num_query_pids, num_query_imgs = self.process_dir(self.query_dir, relabel=False)
        gallery,num_gallery_pids, num_gallery_imgs = self.process_dir(self.gallery_dir, relabel=False)
        if self.market1501_500k:
