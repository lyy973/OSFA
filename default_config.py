...
def get_default_config():
    ...
    # model
    cfg.model = CN()  # 在cfg下创建新配置节点cfg.model,并给该节点的属性配置默认值
    cfg.model.name = 'resnet50'  # 换了
    ...
    cfg.data.sources = ['market1501']  # 换了
    cfg.data.targets = ['market1501']  # 换了
